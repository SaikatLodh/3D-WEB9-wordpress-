...
function canvas(){const canvas = document.querySelector(".page1>canvas");
...
document.querySelector(".page3-text2 p").textContent.split(" ").forEach(function(dets){

    clutter += `<span> ${dets} </span>`  

    document.querySelector(".page3-text2 p").innerHTML = clutter;

})


gsap.to(".page3-text2 p>span",{
    scrollTrigger:{
        trigger:`.page3-text2 p>span`,
        start:`top bottom`,
        end:`bottom 33%`,
        scroller:`.main`,
        scrub:`.5`,
...
document.querySelector(".page4-text2 p").textContent.split(" ").forEach(function(dets){

    clutter += `<span> ${dets} </span>`  

    document.querySelector(".page4-text2 p").innerHTML = clutter;

})


gsap.to(".page4-text2 p>span",{
    scrollTrigger:{
        trigger:`.page4-text2 p>span`,
        start:`top bottom`,
        end:`bottom 33%`,
        scroller:`.main`,
        scrub:`.5`,
